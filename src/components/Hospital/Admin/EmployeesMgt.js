    ...
    <div>
      ...
      <Card style={{marginTop:'30px',height:'300px',marginLeft:'-20px'}}>
        ...
        <Card.Body style={{marginTop:'-180px' ,textAlign:'start',height:'280px'}} >
          ...
          <input style={{width:'300px'}}  type='text' name='Name' onChange={handleChange}   value={seteditvalue.Name} placeholder={value.Name}></input>
          <Card.Text> Contact:</Card.Text>
          <input style={{width:'300px'}}  type='number' name='mobnum' onChange={handleChange} value={seteditvalue.mobnum} placeholder={value.mobnum} ></input>
          <Card.Text> Department:</Card.Text>
          <input style={{width:'300px'}}  type='text' name='department' onChange={handleChange} value={seteditvalue.department} placeholder={value.department}></input>
          </div>
          <div className='sraw'>
          <Card.Text> Age:</Card.Text>
          <input style={{width:'100px'}}  type='2number' name='age' onChange={handleChange} value={seteditvalue.age} placeholder={value.age}></input>
         <div style={{marginLeft:'130px',marginTop:'-66px'}}>
          <Card.Text> Id:</Card.Text>
          <input  style={{width:'100px'}} placeholder={value.id}  type='text'   name='id' onChange={handleChange} value={seteditvalue.id} ></input>
          </div>
          <Card.Text> Discription:</Card.Text>
          <input  style={{width:'300px',height:'105px' ,textAlign:'start'}} type='text'  name='descrp' onChange={handleChange} value={seteditvalue.descrp} placeholder={value.descrp}></input>
 ...
 */}
        ...
        <button type='submit' className='cardfoot'  style={{marginLeft:'400px'}}>Update</button>
